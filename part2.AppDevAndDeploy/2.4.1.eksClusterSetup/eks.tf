...
# Terraform을 이용한 AWS EKS 클러스터 생성 스크립트 예제
...
resource "aws_iam_role_policy_attachment" "eks_role_vpc_attachment" {
  role       = aws_iam_role.eks_role.name
...
resource "aws_iam_role_policy_attachment" "eks_node_ec2_registry_attachment" {
  role       = aws_iam_role.eks_node_role.name
